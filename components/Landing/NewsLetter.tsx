      ...
      <div className="relative z-10 flex flex-col items-center gap-6 px-6 py-16 text-center md:px-16 md:py-20">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="mx-auto max-w-md text-sm leading-relaxed text-muted-foreground md:text-base">
            Join thousands of subscribers and be the first to hear about new
            drops, exclusive deals, and more.
          </p>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            className="group inline-flex h-12 items-center justify-center gap-2 rounded-full bg-primary px-7 text-sm font-bold text-primary-foreground transition-all hover:opacity-90 active:scale-95"
          >
            Subscribe
